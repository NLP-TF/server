...
def load_model_and_tokenizer():
    ...
    try:
        ...
        try:
            ...
            logger.error(f"❌ Failed to download model weights: {str(e)}", exc_info=True)
            raise
        ...
        try:
            ...
            logger.info(f"✅ Model architecture initialized. Type: {type(model).__name__}")
            ...
            try:
                ...
                with torch.no_grad():
                    ...
                    logger.info(f"✅ Test prediction successful. Output shape: {output.shape}")
