...
class RankingService:
    ...
    def _save_rankings(self):
        ...
        try:
            ...
            for nickname, player in self.rankings.items():
                print(f"Saving player {nickname}: {player.dict()}")
    ...
    def update_ranking(self, nickname: str, score: float, user_type: str = None, session_id: str = None):
        ...
        save_success = self._save_rankings()
