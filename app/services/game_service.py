        ...
        try:
            ...
            if avg_score >= 75:
                if user_type == "T" or user_type == UserType.THINKING:
                    return (
                        "당신은 T 유형으로서 F 유형의 감정을 정말 잘 이해하고 있어요! "
                        "상대방의 감정에 공감하는 능력이 뛰어나네요."
                    )
                else:
                    return (
                        "당신은 F 유형으로서 T 유형의 사고 방식을 정말 잘 이해하고 있어요! "
                ...
                if user_type == "T" or user_type == UserType.THINKING:
                    return (
                        "T 유형으로서 F 유형의 감정을 잘 이해하고 계세요. "
                        "약간의 연습만 더 하면 더 나은 결과를 얻을 수 있을 거예요!"
                    )
                else:
                    return (
                        "F 유형으로서 T 유형의 사고 방식을 잘 이해하고 계세요. "
                ...
                if user_type == "T" or user_type == UserType.THINKING:
                    return (
                        "T 유형으로서 F 유형의 감정을 이해하는 데 조금 어려움이 있으신 것 같아요. "
                        "상대방의 감정에 더 공감하려는 노력이 필요해 보여요."
                    )
                else:
                    return (
                        "F 유형으로서 T 유형의 사고 방식을 이해하는 데 조금 어려움이 있으신 것 같아요. "
